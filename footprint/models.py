...
class Post(models.Model):
    ...
    electricityGreen = models.IntegerField(default=100, choices=electricityGreenChoices.choices, verbose_name=(" იყენებთ მწვანე ენერგიას?"))
    ...
    heatingGasUsed = models.BooleanField(default=0, choices=heatingGasChoices.choices, verbose_name=(" გამოიყენება თქვენ სახლში ზეთი, ქვანახშირი, შეშა ან ჩამოსხმული გაზი გასათბობად?"))
    heatingOilUsed = models.IntegerField(blank=True, null=True, verbose_name=(" გამოყენებული ზეთი გასული წლის განმავლობაში (ლიტრებში)"))
    coalUsed = models.IntegerField(blank=True, null=True, verbose_name=(" გამოიყენებული ქვანახშირი გასული წლის განმავლობაში (კილოგრამებში)"))
    woodUsed = models.IntegerField(blank=True, null=True, verbose_name=(" გამოყენებული შეშა გასული წლის განმავლობაში (კილოგრამებში)"))
    bottledGasUsed = models.IntegerField(blank=True, null=True, verbose_name=(" გამოყენებული ჩამოსხმული გაზი გასული წლის განმავლობაში (კილოგრამებში)"))
    ...
    miscSpending = models.DecimalField(max_digits=6, null=True, decimal_places=2, default=34, choices=miscSpendingChoices.choices, verbose_name=(" რა რაოდენობას ხარჯავთ სხვადასხვა ხარჯებში?"))
    recyclePGM = models.DecimalField(max_digits=6, null=True, decimal_places=2, blank=True, default=0, choices=recyclePGMChoices.choices, verbose_name=(" ქაღალდს, მინას და ლითონს ამუშავებთ?"))
    recyclePlastic = models.DecimalField(max_digits=6, null=True, decimal_places=2, blank=True, default=0, choices=recyclePlasticChoices.choices, verbose_name=(" პლასტმასს ამუშავებთ გარდა პოლიეთილენის პარკებისა?"))
    totalAmount = 0
    planetsAmount = 0
    electricityAmount = 0
